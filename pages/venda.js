                                        ...
                                        <div key={imovel.id} className="col-12 col-md-6 col-xl-3 py-4">
                                            <Link href={`/imovel/${imovel.id}`} className="d-flex flex-column shadow h-100 item-grid">                                        
                                                <div className="foto position-relative">
                                                    { imovel.imagem ? <Image src={`${urlImgs}/${imovel.imagem}`} alt={imovel.tipo} width="310" height="200" />  : ""}
                                                    { !imovel.imagem  && imovel.maisimagens ? <Image src={Sm1Foto} alt={imovel.tipo} width="310" height="200" /> : "" }
                                                    { !imovel.imagem  && !imovel.maisimagens ? <Image src={SmFoto} alt={imovel.tipo} width="310" height="200" /> : "" }      
